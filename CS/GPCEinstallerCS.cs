        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                if (ReadKey().Key == ConsoleKey.Y)
                {
                    ...
                    File.Delete("GPCE/CS/GPCE.cs");
                    File.Delete("GPCE/GPCEinstallerCS.sh");
                    File.Delete("GPCE/CS/GPCEinstallerCS.cs");
					File.Delete("GPCE/GPCEinstallerCS.exe");
					File.Delete("GPCE/index.html");
                    File.Copy("GPCE/CS/GPCE.exe","GPCE/GPCE.exe");
                    File.Copy("GPCE/CS/tc.txt","GPCE/tc.txt");
                    File.Copy("GPCE/CS/privacy.txt","GPCE/privacy.txt");
                    File.Copy("GPCE/CS/license.txt","GPCE/license.txt");
                    File.Delete("GPCE/CS/GPCE.exe");
